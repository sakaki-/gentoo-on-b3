...
:--- | ---: | ---: | ---:
B3 with or without Internal Drive | 1.4.1 | [genb3img.xz](https://github.com/sakaki-/gentoo-on-b3/releases/download/1.4.1/genb3img.xz) | [genb3img.xz.asc](https://github.com/sakaki-/gentoo-on-b3/releases/download/1.4.1/genb3img.xz.asc)
...
```
# wget -c https://github.com/sakaki-/gentoo-on-b3/releases/download/1.4.1/genb3img.xz
# wget -c https://github.com/sakaki-/gentoo-on-b3/releases/download/1.4.1/genb3img.xz.asc
```
